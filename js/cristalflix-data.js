...
function abrirReel(reelId) {
    ...
    // Adicionar classe para modal do Instagram
    if (modalContent) {
    ...
    // Criar embed do Instagram com classe específica
    container.innerHTML = `
        <iframe 
...
function abrirVideo(videoId) {
    ...
    // Remover classe do Instagram se existir
    if (modalContent) {
    ...
    // Definir conteúdo
    titulo.textContent = video?.titulo || `Vídeo de Treinamento`;
    descricao.textContent = video?.descricao || 'Conteúdo educativo da Universidade Cristal Sete';
